...
CREATE TABLE "catalog_categories" ("id" uuid NOT NULL, "tenant_id" uuid NULL, "display_order" bigint NOT NULL DEFAULT 0, "is_active" boolean NOT NULL DEFAULT true, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "parent_id" uuid NULL, "outlet_id" uuid NULL, PRIMARY KEY ("id"), CONSTRAINT "catalog_categories_catalog_categories_children" FOREIGN KEY ("parent_id") REFERENCES "catalog_categories" ("id") ON UPDATE NO ACTION ON DELETE SET NULL, CONSTRAINT "catalog_categories_outlets_catalog_categories" FOREIGN KEY ("outlet_id") REFERENCES "outlets" ("id") ON UPDATE NO ACTION ON DELETE SET NULL);
-- Create index "catalogcategory_display_order" to table: "catalog_categories"
CREATE INDEX "catalogcategory_display_order" ON "catalog_categories" ("display_order");
-- Create index "catalogcategory_tenant_id_is_active" to table: "catalog_categories"
CREATE INDEX "catalogcategory_tenant_id_is_active" ON "catalog_categories" ("tenant_id", "is_active");
-- Create index "catalogcategory_tenant_id_outlet_id" to table: "catalog_categories"
CREATE INDEX "catalogcategory_tenant_id_outlet_id" ON "catalog_categories" ("tenant_id", "outlet_id");
-- Create "catalog_items" table
CREATE TABLE "catalog_items" ("id" uuid NOT NULL, "tenant_id" uuid NOT NULL, "inventory_item_id" uuid NULL, "is_available" boolean NOT NULL DEFAULT true, "is_featured" boolean NOT NULL DEFAULT false, "lead_time_minutes" bigint NULL, "image_url" character varying NULL, "sku" character varying NULL, "recipe_id" uuid NULL, "display_order" bigint NOT NULL DEFAULT 0, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "category_id" uuid NOT NULL, "outlet_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "catalog_items_catalog_categories_items" FOREIGN KEY ("category_id") REFERENCES "catalog_categories" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "catalog_items_outlets_catalog_items" FOREIGN KEY ("outlet_id") REFERENCES "outlets" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create index "catalogitem_display_order" to table: "catalog_items"
CREATE INDEX "catalogitem_display_order" ON "catalog_items" ("display_order");
-- Create index "catalogitem_sku" to table: "catalog_items"
CREATE INDEX "catalogitem_sku" ON "catalog_items" ("sku");
-- Create index "catalogitem_tenant_id_category_id" to table: "catalog_items"
CREATE INDEX "catalogitem_tenant_id_category_id" ON "catalog_items" ("tenant_id", "category_id");
-- Create index "catalogitem_tenant_id_is_available" to table: "catalog_items"
CREATE INDEX "catalogitem_tenant_id_is_available" ON "catalog_items" ("tenant_id", "is_available");
-- Create index "catalogitem_tenant_id_outlet_id" to table: "catalog_items"
CREATE INDEX "catalogitem_tenant_id_outlet_id" ON "catalog_items" ("tenant_id", "outlet_id");
-- Create "cart_items" table
CREATE TABLE "cart_items" ("id" uuid NOT NULL, "variant_id" uuid NULL, "name_snapshot" character varying NOT NULL, "variant_name_snapshot" character varying NULL, "quantity" bigint NOT NULL DEFAULT 1, "unit_price" double precision NOT NULL, "total_price" double precision NOT NULL, "notes" text NULL, "modifiers" jsonb NULL, "metadata" jsonb NULL, "created_at" timestamptz NOT NULL, "updated_at" timestamptz NOT NULL, "cart_id" uuid NOT NULL, "catalog_item_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "cart_items_carts_items" FOREIGN KEY ("cart_id") REFERENCES "carts" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION, CONSTRAINT "cart_items_catalog_items_cart_items" FOREIGN KEY ("catalog_item_id") REFERENCES "catalog_items" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create index "cartitem_cart_id" to table: "cart_items"
CREATE INDEX "cartitem_cart_id" ON "cart_items" ("cart_id");
-- Create index "cartitem_catalog_item_id" to table: "cart_items"
CREATE INDEX "cartitem_catalog_item_id" ON "cart_items" ("catalog_item_id");
-- Create "catalog_item_assets" table
CREATE TABLE "catalog_item_assets" ("id" uuid NOT NULL, "asset_type" character varying NOT NULL, "url" character varying NOT NULL, "metadata" jsonb NULL, "display_order" bigint NOT NULL DEFAULT 0, "created_at" timestamptz NOT NULL, "catalog_item_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "catalog_item_assets_catalog_items_assets" FOREIGN KEY ("catalog_item_id") REFERENCES "catalog_items" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create index "catalogitemasset_asset_type" to table: "catalog_item_assets"
CREATE INDEX "catalogitemasset_asset_type" ON "catalog_item_assets" ("asset_type");
-- Create index "catalogitemasset_catalog_item_id" to table: "catalog_item_assets"
CREATE INDEX "catalogitemasset_catalog_item_id" ON "catalog_item_assets" ("catalog_item_id");
...
-- Create "catalog_item_dietary_tags" table
CREATE TABLE "catalog_item_dietary_tags" ("catalog_item_id" uuid NOT NULL, "dietary_tag_id" bigint NOT NULL, PRIMARY KEY ("catalog_item_id", "dietary_tag_id"), CONSTRAINT "catalog_item_dietary_tags_catalog_item_id" FOREIGN KEY ("catalog_item_id") REFERENCES "catalog_items" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "catalog_item_dietary_tags_dietary_tag_id" FOREIGN KEY ("dietary_tag_id") REFERENCES "dietary_tags" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
-- Create "catalog_item_schedules" table
CREATE TABLE "catalog_item_schedules" ("id" uuid NOT NULL, "day_of_week" bigint NOT NULL, "time_start" character varying NOT NULL, "time_end" character varying NOT NULL, "created_at" timestamptz NOT NULL, "catalog_item_id" uuid NOT NULL, PRIMARY KEY ("id"), CONSTRAINT "catalog_item_schedules_catalog_items_schedules" FOREIGN KEY ("catalog_item_id") REFERENCES "catalog_items" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION);
-- Create index "catalogitemschedule_catalog_item_id" to table: "catalog_item_schedules"
CREATE INDEX "catalogitemschedule_catalog_item_id" ON "catalog_item_schedules" ("catalog_item_id");
-- Create index "catalogitemschedule_day_of_week" to table: "catalog_item_schedules"
CREATE INDEX "catalogitemschedule_day_of_week" ON "catalog_item_schedules" ("day_of_week");
...
CREATE TABLE "user_favorite_items" ("user_id" uuid NOT NULL, "catalog_item_id" uuid NOT NULL, PRIMARY KEY ("user_id", "catalog_item_id"), CONSTRAINT "user_favorite_items_catalog_item_id" FOREIGN KEY ("catalog_item_id") REFERENCES "catalog_items" ("id") ON UPDATE NO ACTION ON DELETE CASCADE, CONSTRAINT "user_favorite_items_user_id" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE);
