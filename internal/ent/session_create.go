...
func (sc *SessionCreate) SetTenantID(u uuid.UUID) *SessionCreate {
...
func (sc *SessionCreate) SetTenant(t *Tenant) *SessionCreate {
...
func (sc *SessionCreate) check() error {
	...
	if _, ok := sc.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant", err: errors.New(`ent: missing required edge "Session.tenant"`)}
	}
	if _, ok := sc.mutation.UserID(); !ok {
...
// SetDeviceID sets the "device_id" field.
func (u *SessionUpsert) SetDeviceID(v uuid.UUID) *SessionUpsert {
...
// SetDeviceID sets the "device_id" field.
func (u *SessionUpsertOne) SetDeviceID(v uuid.UUID) *SessionUpsertOne {
	return u.Update(func(s *SessionUpsert) {
		s.SetDeviceID(v)
	})
}
...
// SetDeviceID sets the "device_id" field.
func (u *SessionUpsertBulk) SetDeviceID(v uuid.UUID) *SessionUpsertBulk {
	return u.Update(func(s *SessionUpsert) {
		s.SetDeviceID(v)
	})
}
