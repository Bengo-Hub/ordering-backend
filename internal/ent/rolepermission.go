...
type RolePermissionEdges struct {
	...
	Role *OrderingRole `json:"role,omitempty"`
	// Permission holds the value of the permission edge.
	Permission *OrderingPermission `json:"permission,omitempty"`
...
func (e RolePermissionEdges) RoleOrErr() (*OrderingRole, error) {
	if e.Role != nil {
		return e.Role, nil
	} else if e.loadedTypes[0] {
		return nil, &NotFoundError{label: orderingrole.Label}
	}
...
// was not loaded in eager-loading, or loaded but was not found.
func (e RolePermissionEdges) PermissionOrErr() (*OrderingPermission, error) {
	if e.Permission != nil {
		return e.Permission, nil
	} else if e.loadedTypes[1] {
		return nil, &NotFoundError{label: orderingpermission.Label}
	}
...
func (rp *RolePermission) QueryRole() *OrderingRoleQuery {
...
func (rp *RolePermission) QueryPermission() *OrderingPermissionQuery {
