	...
	for i := range columns {
		...
		case outboxevent.FieldStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				oe.Status = outboxevent.Status(value.String)
			}
		case outboxevent.FieldAttempts:
		...
		case outboxevent.FieldLastAttemptAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				...
				oe.LastAttemptAt = new(time.Time)
...
func (oe *OutboxEvent) String() string {
	...
	builder.WriteString(", ")
	if v := oe.LastAttemptAt; v != nil {
		builder.WriteString("last_attempt_at=")
		builder.WriteString(v.Format(time.ANSIC))
	}
	builder.WriteString(", ")
	if v := oe.PublishedAt; v != nil {
		builder.WriteString("published_at=")
		builder.WriteString(v.Format(time.ANSIC))
	}
	builder.WriteString(", ")
	if v := oe.ErrorMessage; v != nil {
