...
func HasRoleWith(preds ...predicate.OrderingRole) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
		step := newRoleStep()
...
func HasPermissionWith(preds ...predicate.OrderingPermission) predicate.RolePermission {
	return predicate.RolePermission(func(s *sql.Selector) {
