...
const (
	// Label holds the string label denoting the orderingpermission type in the database.
	Label = "ordering_permission"
	...
	// Table holds the table name of the orderingpermission in the database.
	Table = "ordering_permissions"
	// RolesTable is the table that holds the roles relation/edge. The primary key declared below.
	RolesTable = "role_permissions"
	// RolesInverseTable is the table name for the OrderingRole entity.
	// It exists in this package in order to avoid circular dependency with the "orderingrole" package.
	RolesInverseTable = "ordering_roles"
...
// Columns holds all SQL columns for orderingpermission fields.
var Columns = []string{
	FieldID,
	FieldPermissionCode,
	FieldName,
...
// OrderOption defines the ordering options for the OrderingPermission queries.
