...
const (
	// Label holds the string label denoting the orderingrole type in the database.
	Label = "ordering_role"
	...
	// Table holds the table name of the orderingrole in the database.
	Table = "ordering_roles"
	...
	// PermissionsInverseTable is the table name for the OrderingPermission entity.
	// It exists in this package in order to avoid circular dependency with the "orderingpermission" package.
	PermissionsInverseTable = "ordering_permissions"
...
// Columns holds all SQL columns for orderingrole fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldRoleCode,
...
// OrderOption defines the ordering options for the OrderingRole queries.
