...
func (rpc *RolePermissionCreate) SetRole(o *OrderingRole) *RolePermissionCreate {
	return rpc.SetRoleID(o.ID)
}

// SetPermission sets the "permission" edge to the OrderingPermission entity.
func (rpc *RolePermissionCreate) SetPermission(o *OrderingPermission) *RolePermissionCreate {
	return rpc.SetPermissionID(o.ID)
}
