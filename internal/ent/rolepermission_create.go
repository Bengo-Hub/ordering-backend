...
func (_c *RolePermissionCreate) SetRole(v *OrderingRole) *RolePermissionCreate {
	return _c.SetRoleID(v.ID)
}

// SetPermission sets the "permission" edge to the OrderingPermission entity.
func (_c *RolePermissionCreate) SetPermission(v *OrderingPermission) *RolePermissionCreate {
