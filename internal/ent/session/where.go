...
func HasTenant() predicate.Session {
...
func HasTenantWith(preds ...predicate.Tenant) predicate.Session {
	return predicate.Session(func(s *sql.Selector) {
		step := newTenantStep()
