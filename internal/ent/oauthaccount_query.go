...
func (oaq *OAuthAccountQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (oaq *OAuthAccountQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (oaq *OAuthAccountQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (oaq *OAuthAccountQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (oaq *OAuthAccountQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (oaq *OAuthAccountQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := oaq.IDs(ctx)
	if err != nil {
		panic(err)
	}
