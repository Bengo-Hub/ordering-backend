...
func (_q *RoleQuery) QueryLegacyPermissions() *PermissionQuery {
...
func (_q *RoleQuery) Clone() *RoleQuery {
	...
	return &RoleQuery{
		...
		withLegacyPermissions: _q.withLegacyPermissions.Clone(),
...
func (_q *RoleQuery) WithLegacyPermissions(opts ...func(*PermissionQuery)) *RoleQuery {
	query := (&PermissionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withLegacyPermissions = query
	return _q
}
...
func (_q *RoleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Role, error) {
	...
	if query := _q.withLegacyPermissions; query != nil {
		if err := _q.loadLegacyPermissions(ctx, query, nodes,
...
func (_q *RoleQuery) loadLegacyPermissions(ctx context.Context, query *PermissionQuery, nodes []*Role, init func(*Role), assign func(*Role, *Permission)) error {
