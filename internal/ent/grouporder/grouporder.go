...
const (
	// Label holds the string label denoting the grouporder type in the database.
	Label = "group_order"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldTenantID holds the string denoting the tenant_id field in the database.
	FieldTenantID = "tenant_id"
	// FieldHostUserID holds the string denoting the host_user_id field in the database.
	...
	// Table holds the table name of the grouporder in the database.
	Table = "group_orders"
	// ParticipantsTable is the table that holds the participants relation/edge.
	ParticipantsTable = "group_participants"
	// ParticipantsInverseTable is the table name for the GroupParticipant entity.
	// It exists in this package in order to avoid circular dependency with the "groupparticipant" package.
	ParticipantsInverseTable = "group_participants"
	// ParticipantsColumn is the table column denoting the participants relation/edge.
	ParticipantsColumn = "group_order_id"
)

// Columns holds all SQL columns for grouporder fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldHostUserID,
...
func StatusValidator(s Status) error {
	switch s {
	case StatusOpen, StatusLocked, StatusCheckedOut, StatusExpired:
		return nil
	default:
		return fmt.Errorf("grouporder: invalid enum value for status field: %q", s)
	}
}

// OrderOption defines the ordering options for the GroupOrder queries.
...
// ByHostUserID orders the results by the host_user_id field.
func ByHostUserID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldHostUserID, opts...).ToFunc()
}
