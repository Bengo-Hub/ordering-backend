...
func (_c *RoleCreate) AddLegacyPermissionIDs(ids ...uuid.UUID) *RoleCreate {
	_c.mutation.AddLegacyPermissionIDs(ids...)
	return _c
}

// AddLegacyPermissions adds the "legacy_permissions" edges to the Permission entity.
func (_c *RoleCreate) AddLegacyPermissions(v ...*Permission) *RoleCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddLegacyPermissionIDs(ids...)
}
...
func (_c *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.LegacyPermissionsIDs(); len(nodes) > 0 {
